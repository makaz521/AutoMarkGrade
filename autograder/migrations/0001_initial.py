# Generated by Django 4.2.11 on 2024-03-26 09:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'Lecturer'), (2, 'Auditor')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.FileField(upload_to='marking_tasks/')),
                ('marking_scheme', models.FileField(upload_to='marking_schemes/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('uploaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='uploaded_marking_tasks', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
